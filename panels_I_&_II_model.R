...
#
# Output: the donor's age estimated by the panel I & II model.
...
## Load panel I & II model ---------------------------------------------------------
# https://github.com/XiaoChao369/Xiao-et-al-2023-age-semen-models
setwd(dirModel)
two_panels_model <- readRDS("panels_I_&_II_brnn_model.rds")
...
setwd(dirResult)
write.csv(meth_data, "meth_data_panels_I_&_II.csv", quote = FALSE, row.names = FALSE)
...
## Estimate age using the panel I & II model ---------------------------------------
# Estimate age
...
setwd(dirResult)
write.csv(estimated_age, "estimated_age_panels_I_&_II.csv", quote = FALSE, 
          row.names = FALSE)
